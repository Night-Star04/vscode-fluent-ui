...
<div align="center"><a href="README.md">English</a> | 繁體中文</div>
...
> 直接連結：[Open VSX Registry - Fluent UI](https://open-vsx.org/extension/NightSky-Studio/vscode-fluent-ui-continued)
...
1. 從 [Releases](https://github.com/Night-Star04/vscode-fluent-ui/releases/latest)
   下載最新版本的安裝文件
...
3. 安裝套件
    ...
    > 您也可以通過命令行使用 `code --install-extension <path-to-vsix>` 進行安裝
...
>
> 在某些情況下，這可能會導致低對比度或使某些內容難以閱讀，具體取決於您的壁紙，因此在運行安裝時請記住這一點。
>
